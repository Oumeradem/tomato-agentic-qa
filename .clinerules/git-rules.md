...
- NEVER commit `.env`, real credentials, secrets, `node_modules/`, `reports/`, `allure-results/`, or `dist/`. Failure artifacts live under `reports/artifacts/` and are git-ignored.
